...
config = {
    'client_id':     config_file["Cube_id"],
    'server':        config_file["MQTT_server"],
    'port':          config_file["MQTT_port"],
    'user':          config_file["MQTT_user"],
    'password':      config_file["MQTT_password"],
    'keepalive':     60,
    'ping_interval': 0,
    'ssl':           False,
    'ssl_params':    {},
    ...
    'wifi_coro':     eliza,
    'connect_coro':  eliza,
    'ssid':          config_file["wifi_ssid"],
    'wifi_pw':       config_file["wifi_password"],
}
